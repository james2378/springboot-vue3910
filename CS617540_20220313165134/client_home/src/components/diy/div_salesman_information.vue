<template>
	<div class="diy_details_box diy_div_salesman_information">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "salesman_information",
					source_field: "salesman_information_id",
					source_id: this.obj["salesman_information_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/salesman_information/set?salesman_information_id=' + _this.obj["salesman_information_id"], {
								praise_len
							}, (res) => {
								if(res.result){
